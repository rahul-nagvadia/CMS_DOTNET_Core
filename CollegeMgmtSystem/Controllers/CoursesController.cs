...
namespace CollegeMgmtSystem.Controllers
{
    ...
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CourseName,Semester,Credit,DepartmentId")] Course course)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Departments, "Id", "DeptName", course.DepartmentId);
            return View(course);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseName,Semester,Credit,DepartmentId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
