...
namespace CollegeMgmtSystem.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DeptName,DeptDuration,DeptFees")] Department department)
        {
            ...
            _logger.LogInformation("Create action failed. ModelState is invalid."); // Add log message
            return View(department);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DeptName,DeptDuration,DeptFees")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
